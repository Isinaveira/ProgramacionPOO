...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < 3 ; i++)
            reproduction();
        //SE GENERA EL FICHERO FUERA DEL PAQUETE, DESCOMENTAR LOS OTROS PARA GENERAR JSON Y XML
        Ficheros.generaFicheroAnimales("animales", FileTypes.CSV);
        //Ficheros.generaFicheroAnimales("animales", FileTypes.JSON);
        //Ficheros.generaFicheroAnimales("animales", FileTypes.XML);

        System.out.println("Animales totales: "+Animal.getListAnimals().size());
    }
